...
(use-package consult
  ...
  (consult-buffer-filter '("^ " "\\` " "\\*Echo Area" "\\*Minibuf" "\\*Quail Completions" "\\*Backtrace"
                           "\\*tidewave""\\*Mcp" "\\*filesystem events" "\\*gptel" "\\*opencode-serve*" "\\*OpenCode Sessions"
			     "\\*elixir-ls" "Flymake log" "Shell command output" "direnv" "\\*scratch" "Shell:" "^acp-client-stderr"
