...
#+end_src
* Olivetti Fringe Suppression
In olivetti buffers (markdown-view-mode, agent-shell, etc.), suppress the left fringe that
olivetti-reset-window would otherwise restore from the global fringe-mode setting.
#+begin_src emacs-lisp
